...
- Cada respuesta también puede recibir respuestas, formando una conversación anidada sin un límite fijo de niveles.
...
- Responder una respuesta y continuar la conversación durante varios niveles.
